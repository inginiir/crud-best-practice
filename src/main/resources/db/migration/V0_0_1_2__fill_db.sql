...
values (nextval('medication_id_generator'), 'Medication 1', 100, 'CODE1', './images/medication1.jpg'),
       ...
       (nextval('medication_id_generator'), 'Medication 3', 75, 'CODE3', './images/medication3.jpg'),
       (nextval('medication_id_generator'), 'Medication 4', 200, 'CODE4', './images/medication4.jpg'),
       (nextval('medication_id_generator'), 'Medication 5', 150, 'CODE5', './images/medication5.jpg'),
       (nextval('medication_id_generator'), 'Medication 6', 125, 'CODE6', './images/medication6.jpg'),
       (nextval('medication_id_generator'), 'Medication 7', 80, 'CODE7', './images/medication7.jpg'),
       (nextval('medication_id_generator'), 'Medication 8', 40, 'CODE8', './images/medication8.jpg'),
       (nextval('medication_id_generator'), 'Medication 9', 100, 'CODE9', './images/medication9.jpg'),
       (nextval('medication_id_generator'), 'Medication 10', 50, 'CODE10', './images/medication10.jpg'),
       (nextval('medication_id_generator'), 'Medication 11', 75, 'CODE11', './images/medication11.jpg'),
       (nextval('medication_id_generator'), 'Medication 12', 200, 'CODE12', './images/medication12.jpg'),
       (nextval('medication_id_generator'), 'Medication 13', 150, 'CODE13', './images/medication13.jpg'),
       (nextval('medication_id_generator'), 'Medication 14', 125, 'CODE14', './images/medication14.jpg'),
       (nextval('medication_id_generator'), 'Medication 15', 80, 'CODE15', './images/medication15.jpg'),
       (nextval('medication_id_generator'), 'Medication 16', 40, 'CODE16', './images/medication16.jpg'),
       (nextval('medication_id_generator'), 'Medication 17', 100, 'CODE17', './images/medication17.jpg'),
       (nextval('medication_id_generator'), 'Medication 18', 50, 'CODE18', './images/medication18.jpg'),
...
values ((select id from drones where serial_number = 'DRONE001'), (select id from medications where code = 'CODE2')),
       ...
       ((select id from drones where serial_number = 'DRONE004'), (select id from medications where code = 'CODE6')),
       ((select id from drones where serial_number = 'DRONE004'), (select id from medications where code = 'CODE7')),
       ((select id from drones where serial_number = 'DRONE004'), (select id from medications where code = 'CODE8')),
       ((select id from drones where serial_number = 'DRONE004'), (select id from medications where code = 'CODE9')),
       ((select id from drones where serial_number = 'DRONE006'), (select id from medications where code = 'CODE13')),
       ((select id from drones where serial_number = 'DRONE006'), (select id from medications where code = 'CODE14')),
       ((select id from drones where serial_number = 'DRONE007'), (select id from medications where code = 'CODE20')),
       ((select id from drones where serial_number = 'DRONE007'), (select id from medications where code = 'CODE20')),
       ((select id from drones where serial_number = 'DRONE008'), (select id from medications where code = 'CODE15')),
